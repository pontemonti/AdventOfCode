...
namespace Pontemonti.AdventOfCode.Test.Year2019
{
    ...
    public class Day1Puzzle2Tests
    {
        ...
        public void TestSolve()
        {
            ...
            int actualResult = Day1Puzzle2.CalculateTotalFuelRequirements();
            Assert.AreEqual(expectedResult, actualResult);
        }

        private void TestCalculateFuelRequirement(int mass, int expectedFuelRequirement)
        {
            int actualFuelRequirement = Day1Puzzle2.CalculateFuelRequirements(mass);
