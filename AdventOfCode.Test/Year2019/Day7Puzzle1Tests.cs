...
namespace Pontemonti.AdventOfCode.Test.Year2019
{
    ...
    public class Day7Puzzle1Tests
    {
        ...
        public void TestSolve()
        {
            ...
            (long actualResult, _) = Day7Puzzle1.GetResult(InputHelper.ReadIntegerCommaList(Day7Puzzle1.input).ToArray());
        ...
        private void TestGetResult(string programString, int expectedOutputSignal)
        {
            ...
            (long actualOutputSignal, int[] actualPhaseSettings) = Day7Puzzle1.GetResult(program);
