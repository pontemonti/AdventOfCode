...
{
    [TestClass]
    public class Day07Puzzle2Tests
    {
        [TestMethod]
        public void TestSolve()
        {
            ...
            (long actualResult, _) = Day07Puzzle2.GetResult(InputHelper.ReadIntegerCommaList(Day07Puzzle1.input).ToArray());
        ...
        private void TestGetResult(string programString, int expectedOutputSignal)
        {
            ...
            (long actualOutputSignal, int[] actualPhaseSettings) = Day07Puzzle2.GetResult(program);
