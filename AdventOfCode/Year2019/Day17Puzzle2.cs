...
namespace Pontemonti.AdventOfCode.Year2019
{
    ...
    /// flare. The vacuum robot can do this automatically if it gets into range of 
    /// a robot. However, you can't see the other robots on the camera, so you need 
    /// to be thorough instead: you need to make the vacuum robot visit every part 
    ...
    /// many units. Movement functions may not call other movement functions. 
    /// Again, separate the actions with commas and end the list with a newline. 
    /// For example, to move forward 10 units, turn left, move forward 8 units, 
    /// turn right, and finally move forward 6 units, provide the string 
    /// 10,L,8,R,6 and then a newline.
    /// 
    /// Finally, you will be asked whether you want to see a continuous video 
    /// feed; provide either y or n and a newline. Enabling the continuous video 
    /// feed can help you see what's going on, but it also requires a significant 
    /// amount of processing power, and may even cause your Intcode computer to 
    /// overheat.
    /// 
    ...
    /// solar flare, it also can't help but leave them squeaky clean, collecting 
    /// any space dust it finds. Once it finishes the programmed set of movements, 
    /// assuming it hasn't drifted off into space, the cleaning robot will return 
    /// to its docking station and report the amount of space dust it collected as 
    ...
    /// </summary>
    public class Day17Puzzle2 : IPuzzle
    {
