...
namespace Pontemonti.AdventOfCode.Year2019
{
    ...
    /// </summary>
    public class Day05Puzzle2 : IPuzzle
    {
        ...
        {
            int[] integers = InputHelper.ReadIntegerCommaList(Day05Puzzle1.input).ToArray();
            IntcodeComputer intcodeComputer = new IntcodeComputer(integers, 5);
            intcodeComputer.Run();
