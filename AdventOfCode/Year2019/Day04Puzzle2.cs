...
namespace Pontemonti.AdventOfCode.Year2019
{
    ...
    /// </summary>
    public class Day04Puzzle2 : IPuzzle
    {
        public void Solve()
        {
        ...
        {
            FuelDepotPasswordFinder fuelDepotPasswordFinder = new FuelDepotPasswordFinder(Day04Puzzle1.numberOfDigits, Day04Puzzle1.minimum, Day04Puzzle1.maximum);
