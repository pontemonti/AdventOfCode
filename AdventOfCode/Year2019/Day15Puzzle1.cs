...
namespace Pontemonti.AdventOfCode.Year2019
{
    ...
    public class Day15Puzzle1 : IPuzzle
    {
        public void Solve()
        {
            ...
            Console.WriteLine($"Fewest number of movement commands to the oxygen system: {result}");
        }

        public static int CalculateResult()
        {
            RepairDroid repairDroid = RepairDroid.Create();
            List<RepairDroidNavigationStep> path = repairDroid.FindShortestPathToOxygenSystem();
            return path.Count;
        }
    }
}
