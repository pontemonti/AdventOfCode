...
namespace Pontemonti.AdventOfCode.Year2019
{
    ...
    public class Day17Puzzle1 : IPuzzle
    {
        ...
        public void Solve()
        {
            ...
            Console.WriteLine($"Sum of the alignment paramters for the scaffold intersections: {result}");
        }

        public static int CalculateResult()
        {
            AsciiProgram asciiProgram = AsciiProgram.Create();
            AsciiMap asciiMap = asciiProgram.GenerateAsciiMap();
            int result = asciiMap.CalculateSumOfAlignmentParameters();
            return result;
        }
    }
}
